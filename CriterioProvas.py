...
notaP1 = np.asarray(data['P1']).reshape(-1,1)
notaP2 = np.asarray(data['P2']).reshape(-1,1)
features = np.concatenate((notaP1 , notaP2, percFalta),axis=1)
...
tree.plot_tree(Arvore,feature_names=['NotaP1', 'NotaP2', 'PercFalta',],class_names=['Aprovado', 'Reprovado'],
